...
@interface GAFAJWorkViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
@property (nonatomic) NSMutableArray * positiondataLasts;
@property (nonatomic) UITableView * tableView;
@end

@implementation GAFAJWorkViewController
