//
//  SecondScrollowViewViewController.m
//  ForAJob
//
...
@interface SecondScrollowViewViewController ()<UIPickerViewDataSource,UIPickerViewDelegate>
{
    UIView *view ;
    UIButton *skipButton;
...
@implementation SecondScrollowViewViewController
...
- (void)viewDidLoad {
    ...
    if (![currentController isEqualToString:@"GAFAJRecordViewController"]) {
        ...
        [FAJUserDef setObject:@"SecondScrollowViewViewController" forKey:@"currentController"];
    }
    // [FAJUserDef setObject:@"SecondScrollowViewViewController" forKey:@"currentController"];
    self.workData = [NSMutableArray arrayWithObjects:@"小学",@"初中",@"高中",@"大专",@"本科",@"硕士",@"博士", nil];
    ...
    UIPickerView *pickView = [[UIPickerView alloc]initWithFrame:CGRectMake((view.width-100)/2, 149, 100, view.height-149*2)];
    ...
    [FAJUserDef setObject:self.workData[3] forKey:@"work"];
...
-(void)lookButtonClick{
    ...
    ThridScrollowViewViewController * vc =[[ThridScrollowViewViewController alloc]init];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    UILabel *pickerLabel = [[UILabel alloc] init];
        ...
        pickerLabel.text = self.workData[row];
...
{
    [FAJUserDef setObject:self.workData[row] forKey:@"work"];
